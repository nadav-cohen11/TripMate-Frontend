...
const ProfileCard = ({ user, age, swipeInfo }) => {
  ...
  const photo =
    user.photos[photoIndex] || "/assets/images/Annonymos_picture.jpg";
        ...
        {travel.travelDates && (
          <div className="mt-2 space-y-1 text-sm">
            ...
            <div className="flex items-center gap-2">
              <Globe2 size={16} />
              <span>
                <strong>Destinations:</strong> {travel.destinations.join(", ")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <Users size={16} />
              <span>
                <strong>Group Size:</strong> {travel.groupSize}
              </span>
            </div>
          </div>
        )}
