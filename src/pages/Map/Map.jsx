...
export const Map = () => {
  ...
  const { places, loading: loadingPlaces } = useNearbyPlaces(
    appliedFilter,
    coordinates,
    appliedRadius,
  );
  ...
  return (
    <div className='bg-gradient-to-br from-sky-100 via-blue-50 to-blue-200  relative min-h-screen overflow-hidden bg-white'>
      <TripMateTitle />
