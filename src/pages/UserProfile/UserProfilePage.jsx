        ...
        <div className="absolute top-6 right-6 flex items-center gap-3 z-50">
          ...
          <Dialog open={openSignOut} onOpenChange={setOpenSignOut}>
            <DialogTrigger asChild>
              <button
                className="px-2 py-1.5 bg-red-500 hover:bg-red-600 text-white rounded-lg text-xs font-medium transition-colors duration-200 shadow-sm"
              >
                Sign Out
              </button>
            </DialogTrigger>
            <DialogContent>
              ...
              <DialogFooter>
                <DialogClose asChild>
                  <button className="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium">Cancel</button>
                </DialogClose>
                <button
