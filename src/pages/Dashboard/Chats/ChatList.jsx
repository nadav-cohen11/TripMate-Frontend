    ...
    <>
      ...
      >
        <div className='mb-8 flex flex-col gap-2'>
          <div
            className='text-2xl font-bold text-[#4a90e2] mb-6 tracking-wide'
        ...
        <div className='flex-1 min-h-0 overflow-y-auto'>
          <h4 className='font-semibold text-[#4a90e2] mb-2 text-lg'>
            Direct Chats
          </h4>
          ...
          <h4 className='font-semibold text-[#4a90e2] mt-8 mb-2 text-lg'>
            Groups
          </h4>
          <div className='space-y-2'>
            {groupChats &&
