...
const ProfileDetails = ({
  ...
  return (
    <div className='overflow-y-auto max-h-[calc(75vh-IMAGE_HEIGHT)] px-4 py-6 space-y-6'>
      {compatibilityScore && (
        <div className='flex items-center gap-2 bg-gray-100 text-[#00BFFF] px-3 py-2 rounded-xl w-max shadow font-semibold mb-4'>
                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-600 mb-4'>
                      ...
                      Adding more details will help you find better travel
                      matches!
                    </p>
                    ...
                    <div className='bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4'>
                      ...
                      <ul className='text-xs text-blue-600 space-y-1'>
                        {(!travel?.travelDates?.start ||
                          !travel?.travelDates?.end) && <li>• Travel dates</li>}
                        {!travel?.destinations?.length && (
                          <li>• Destinations</li>
                        )}
                        {!travel?.groupSize && <li>• Group size</li>}
                        {(!travel?.ageRange?.min || !travel?.ageRange?.max) && (
                          <li>• Age range</li>
                        )}
                        {!travel?.interests?.length && <li>• Interests</li>}
                        {!travel?.travelStyle && <li>• Travel style</li>}
                      </ul>
                    </div>
                  </div>
